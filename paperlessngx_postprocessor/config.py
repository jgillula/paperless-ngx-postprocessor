    ...
    def __init__(self):
        ...
        self.options_spec = {"auth_token": Config.OptionSpec(None, {"metavar": "AUTH_TOKEN",
                             ...
                             "backup": Config.OptionSpec(None, {"nargs": '?',
                                                                ...
                                                                "help": "Backup file to write any changed values to. If no filename is given, one will be automatically generated on the current date and time. (default: {default})"}),
                             ...
                             "rules_dir": Config.OptionSpec("/usr/src/paperless-ngx-postprocessor/rules.d", {"metavar": "RULES_DIR",
                                                                                                             "type": str,
